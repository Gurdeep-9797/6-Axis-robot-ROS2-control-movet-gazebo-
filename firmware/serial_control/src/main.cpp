...
const int SERVO_MAX[NUM_JOINTS] = {600, 600, 600,
                                   600, 600, 600}; // ~180 degrees
...
const int ENC_PINS[NUM_JOINTS][2] = {
    {J1_ENC_A, J1_ENC_B}, {J2_ENC_A, J2_ENC_B}, {J3_ENC_A, J3_ENC_B},
    {J4_ENC_A, J4_ENC_B}, {J5_ENC_A, J5_ENC_B}, {J6_ENC_A, J6_ENC_B}};

// Motor Pins (PWM channel is handled by PCA9685, Direction pins on ESP32)
// Dir pins: {IN1, IN2}
const int DIR_PINS[NUM_JOINTS][2] = {
    {J1_DIR_1, J1_DIR_2}, {J2_DIR_1, J2_DIR_2}, {J3_DIR_1, J3_DIR_2},
    {J4_DIR_1, J4_DIR_2}, {J5_DIR_1, J5_DIR_2}, {J6_DIR_1, J6_DIR_2}};
