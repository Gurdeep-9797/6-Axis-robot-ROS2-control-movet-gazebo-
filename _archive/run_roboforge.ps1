...
Write-Host "   RoboForge WPF + ROS2 + Gazebo Pipeline  " -ForegroundColor Cyan
Write-Host "=============================================" -ForegroundColor Cyan
...
Write-Host "[3/4] Launching RoboForge visual Interface..." -ForegroundColor Yellow
Start-Process dotnet.exe -ArgumentList "run --project d:\Projects\ROBOT\6-Axis-robot-ROS2-control-movet-gazebo-\RoboForge_WPF"
